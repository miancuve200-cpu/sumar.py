...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        #btnVoz { background: #f59e0b; color: white; border: none; padding: 0.6rem 1.2rem; border-radius: 8px; font-size: 1rem; margin-bottom: 1rem; cursor: pointer; }
...
<body>
    ...
    <script>
        ...
        function comprobar(boton, valor) {
            activarVoz(); // ✅ Al tocar cualquier número, ya se activa la voz
            ...
            document.getElementById('siguiente').style.display = 'block'; // ✅ Asegura que se muestre
        }
